...
import com.chuxin.law.ry.db.DBManager;
import com.chuxin.law.ry.db.Friend;
import com.chuxin.law.ry.db.GroupMember;
import com.chuxin.law.ry.db.Groups;
import com.chuxin.law.ry.db.GroupsDao;
import com.chuxin.law.ry.model.SealSearchConversationResult;
...
import com.chuxin.law.ry.server.utils.CommonUtils;
import com.chuxin.law.ry.server.utils.NToast;
import com.chuxin.law.ry.server.utils.OperationRong;
import com.chuxin.law.ry.server.utils.RongGenerate;
import com.chuxin.law.ry.server.utils.json.JsonMananger;
import com.chuxin.law.ry.server.utils.photo.PhotoUtils;
import com.chuxin.law.ry.server.widget.BottomMenuDialog;
import com.chuxin.law.ry.server.widget.DialogWithYesOrNoUtils;
import com.chuxin.law.ry.server.widget.LoadDialog;
import com.chuxin.law.ry.server.widget.SelectableRoundedImageView;
import com.chuxin.law.ry.ui.widget.DemoGridView;
import com.chuxin.law.ry.ui.widget.switchbutton.SwitchButton;
...
public class GroupDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initGroupData() {
        ...
        ImageLoader.getInstance().displayImage(portraitUri, mGroupHeader, TalkLawApplication.getOptions());
            ...
            switch (requestCode) {
                ...
                case UPDATE_GROUP_HEADER:
                    ...
                    if (response5.getCode() == 200) {
                        ImageLoader.getInstance().displayImage(imageUrl, mGroupHeader, TalkLawApplication.getOptions());
    ...
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == getCount() - 1 && isCreated) {
                ...
                ImageLoader.getInstance().displayImage(portraitUri, iv_avatar, TalkLawApplication.getOptions());
                iv_avatar.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
