...
import com.chuxin.law.ry.server.pinyin.PinyinComparator;
import com.chuxin.law.ry.server.pinyin.SideBar;
...
public class SelectFriendsActivity extends BaseActivity implements View.OnClickListener {
    ...
    class StartDiscussionAdapter extends BaseAdapter implements SectionIndexer {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ImageLoader.getInstance().displayImage(portraitUri, viewHolder.mImageView, TalkLawApplication.getOptions());
            return convertView;
        }
