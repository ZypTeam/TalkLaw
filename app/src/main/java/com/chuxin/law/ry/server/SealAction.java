...
import com.chuxin.law.ry.server.response.GetGroupInfoResponse;
...
import com.chuxin.law.ry.server.request.AddGroupMemberRequest;
import com.chuxin.law.ry.server.request.AddToBlackListRequest;
import com.chuxin.law.ry.server.request.AgreeFriendsRequest;
import com.chuxin.law.ry.server.request.ChangePasswordRequest;
import com.chuxin.law.ry.server.request.CheckPhoneRequest;
import com.chuxin.law.ry.server.request.CreateGroupRequest;
import com.chuxin.law.ry.server.request.DeleteFriendRequest;
import com.chuxin.law.ry.server.request.DeleteGroupMemberRequest;
import com.chuxin.law.ry.server.request.DismissGroupRequest;
import com.chuxin.law.ry.server.request.FriendInvitationRequest;
import com.chuxin.law.ry.server.request.JoinGroupRequest;
import com.chuxin.law.ry.server.request.LoginRequest;
import com.chuxin.law.ry.server.request.QuitGroupRequest;
import com.chuxin.law.ry.server.request.RegisterRequest;
import com.chuxin.law.ry.server.request.RemoveFromBlacklistRequest;
import com.chuxin.law.ry.server.request.RestPasswordRequest;
import com.chuxin.law.ry.server.request.SendCodeRequest;
import com.chuxin.law.ry.server.request.SetFriendDisplayNameRequest;
import com.chuxin.law.ry.server.request.SetGroupDisplayNameRequest;
import com.chuxin.law.ry.server.request.SetGroupNameRequest;
import com.chuxin.law.ry.server.request.SetGroupPortraitRequest;
import com.chuxin.law.ry.server.request.SetNameRequest;
import com.chuxin.law.ry.server.request.SetPortraitRequest;
import com.chuxin.law.ry.server.request.VerifyCodeRequest;
import com.chuxin.law.ry.server.response.AddGroupMemberResponse;
import com.chuxin.law.ry.server.response.AddToBlackListResponse;
import com.chuxin.law.ry.server.response.AgreeFriendsResponse;
import com.chuxin.law.ry.server.response.ChangePasswordResponse;
import com.chuxin.law.ry.server.response.CheckPhoneResponse;
import com.chuxin.law.ry.server.response.CreateGroupResponse;
import com.chuxin.law.ry.server.response.DefaultConversationResponse;
import com.chuxin.law.ry.server.response.DeleteFriendResponse;
import com.chuxin.law.ry.server.response.DeleteGroupMemberResponse;
import com.chuxin.law.ry.server.response.DismissGroupResponse;
import com.chuxin.law.ry.server.response.FriendInvitationResponse;
import com.chuxin.law.ry.server.response.GetBlackListResponse;
import com.chuxin.law.ry.server.response.GetFriendInfoByIDResponse;
import com.chuxin.law.ry.server.response.GetGroupInfoResponse;
import com.chuxin.law.ry.server.response.GetGroupMemberResponse;
import com.chuxin.law.ry.server.response.GetGroupResponse;
import com.chuxin.law.ry.server.response.GetTokenResponse;
import com.chuxin.law.ry.server.response.GetUserInfoByIdResponse;
import com.chuxin.law.ry.server.response.GetUserInfoByPhoneResponse;
import com.chuxin.law.ry.server.response.GetUserInfosResponse;
import com.chuxin.law.ry.server.response.JoinGroupResponse;
import com.chuxin.law.ry.server.response.LoginResponse;
import com.chuxin.law.ry.server.response.QiNiuTokenResponse;
import com.chuxin.law.ry.server.response.QuitGroupResponse;
import com.chuxin.law.ry.server.response.RegisterResponse;
import com.chuxin.law.ry.server.response.RemoveFromBlackListResponse;
import com.chuxin.law.ry.server.response.RestPasswordResponse;
import com.chuxin.law.ry.server.response.SendCodeResponse;
import com.chuxin.law.ry.server.response.SetFriendDisplayNameResponse;
import com.chuxin.law.ry.server.response.SetGroupDisplayNameResponse;
import com.chuxin.law.ry.server.response.SetGroupNameResponse;
import com.chuxin.law.ry.server.response.SetGroupPortraitResponse;
import com.chuxin.law.ry.server.response.SetNameResponse;
import com.chuxin.law.ry.server.response.SetPortraitResponse;
import com.chuxin.law.ry.server.response.SyncTotalDataResponse;
import com.chuxin.law.ry.server.response.UserRelationshipResponse;
import com.chuxin.law.ry.server.response.VerifyCodeResponse;
import com.chuxin.law.ry.server.response.VersionResponse;
import com.chuxin.law.ry.server.utils.NLog;
import com.chuxin.law.ry.server.utils.json.JsonMananger;
