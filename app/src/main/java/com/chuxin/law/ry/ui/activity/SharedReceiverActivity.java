...
import com.chuxin.law.ry.ui.widget.linkpreview.LinkPreviewCallback;
import com.chuxin.law.ry.ui.widget.linkpreview.SourceContent;
import com.chuxin.law.ry.ui.widget.linkpreview.TextCrawler;
...
public class SharedReceiverActivity extends BaseActivity {
    ...
    class ShareAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ImageLoader.getInstance().displayImage(bean.getPortraitUri(), holder.mImageView, TalkLawApplication.getOptions());
