...
import com.chuxin.law.ry.ui.activity.AboutRongCloudActivity;
import com.chuxin.law.ry.ui.activity.AccountSettingActivity;
import com.chuxin.law.ry.ui.activity.MyAccountActivity;
...
public class MineFragment extends Fragment implements View.OnClickListener {
    ...
    private void updateUserInfo() {
        ...
        if (!TextUtils.isEmpty(userId)) {
            ...
            ImageLoader.getInstance().displayImage(portraitUri, imageView, TalkLawApplication.getOptions());
        }
    }
