...
import com.chuxin.law.ry.server.response.ContactNotificationMessageData;
import com.chuxin.law.ry.server.utils.NLog;
import com.chuxin.law.ry.server.utils.json.JsonMananger;
import com.chuxin.law.ry.ui.activity.LoginActivity;
...
//        SealUserInfoManager.getInstance().getUserInfo(s);
        UserInfo userInfo = FriendsSp.getFriendsInfo(mContext,s);

        Log.e("tag","getUserInfogetUserInfo1="+userInfo.getName()+" "+userInfo.getUserId()+" "+s);
