...
import com.chuxin.law.audioplayer.download.IDownloadTaskThreadEven;
import com.chuxin.law.audioplayer.download.TaskThread;
...
public class TaskThreadUtil {
    ...
    public TaskThreadUtil(DownloadTask task, IDownloadTaskEvent taskEvent,
