        ...
        public void handleMessage(Message msg) {
            ...
            if (mAudioReceiverListener != null) {
                ...
                if (intent.getAction().equals(ACTION_MUSICSUCCESS)) {
                    ...
                    //
                    //服务被强迫回收
                    if (audioPlayUtils.isPlayServiceForceDestroy()) {
                        audioPlayUtils.setPlayServiceForceDestroy(false);
                        int playStatus = audioPlayUtils.getPlayStatus();
                        if (playStatus == AudioPlayerManager.PLAYING) {

                            //
                            Log.e("app","发送重启后重新播放音频广播");
